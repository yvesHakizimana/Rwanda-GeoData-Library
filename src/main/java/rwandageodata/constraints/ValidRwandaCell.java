...
/**
 * Annotation to validate that a field contains a valid Rwanda cell name.
 * This annotation is used with {@link RwandaCellValidator} to enforce the validation logic.
 */
