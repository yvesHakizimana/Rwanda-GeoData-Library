...
/**
 * Annotation to validate that a field contains a valid Rwanda sector name.
 * This annotation is used with {@link RwandaSectorValidator} to enforce the validation logic.
 */
@Target({ElementType.FIELD})
@Retention(RetentionPolicy.RUNTIME)
@Constraint(validatedBy = RwandaSectorValidator.class)
public @interface ValidRwandaSector {
    /**
     * Specifies the error message to be displayed if the validation fails.
     *
     * @return the default error message.
     */
    String message() default "Invalid Rwanda Sector name.";
